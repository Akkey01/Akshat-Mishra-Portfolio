  ...
  return (
    <section className={styles.container} id="summary">
      <div className={styles.content}>
        <h1 className={styles.title}>Hi, I'm <span className={styles.name}>Akshat Mishra</span></h1>
        <h2 className={styles.headline}>Data Scientist | AI Product Developer | MS CE @NYU</h2>
        ...
        <div className={styles.BtnsContainer}>
          <a className={styles.Btns} href='/Akshat_Mishra_Resume_Data_Science.pdf' download>View My Resume</a>
      ...
      <img className={styles.summaryImg} src={getImageURL("summary/Akshat_Mishra.jpg")} alt='Summary Image' />
